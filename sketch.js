...
function draw() {
 ...
 text (500,430,320);
  ...
  if(particle.body.position.y>285){
    if(particle.body.position.x>160 && particle.body.position.x<300){
      score=score+100
      particle=null
  ...
  if(particle.body.position.x>80 && particle.body.position.x<410){
    score=score+300
    particle=null
    if(turn>=5) gamestate = "end"
  }
  ...
  if(particle.body.position.x>1 && particle.body.position.x<490){
    score=score+500
    particle=null
    if(turn>=5) gamestate = "end"
  }
